...
from Order.Views.Frontend.PaymentAPIs import getPaymentInfo, ConfirmPayment, ConfirmationOfTransaction
...
urlpatterns = [
    ...
    path('frontend/confirm-transaction/', ConfirmationOfTransaction.as_view(), name='confirm-transaction'),
]
